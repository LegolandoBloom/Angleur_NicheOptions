...
Legolando_TempCVarHandlerMixin_AngleurNicheOptions = {}

function Legolando_TempCVarHandlerMixin_AngleurNicheOptions:Init()
...
function Legolando_TempCVarHandlerMixin_AngleurNicheOptions:Set(...)
    local keys = {...}
    local teeburu = self.tempCVarsTable
    if not teeburu or next(teeburu) == nil then 
        print("No valid Temp CVars Table")
...
function Legolando_TempCVarHandlerMixin_AngleurNicheOptions:Release(...)
    local keys = {...}
    local teeburu = self.tempCVarsTable
    if not teeburu or next(teeburu) == nil then 
        print("No valid Temp CVars Table")
...
function Legolando_TempCVarHandlerMixin_AngleurNicheOptions:SetAll()
    local teeburu = self.tempCVarsTable
    if not teeburu or next(teeburu) == nil then 
        print("No valid Temp CVars Table")
        return
...
function Legolando_TempCVarHandlerMixin_AngleurNicheOptions:ReleaseAll()
    local teeburu = self.tempCVarsTable
    if not teeburu or next(teeburu) == nil then 
        print("No valid Temp CVars Table")
        return
